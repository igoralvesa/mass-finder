...
export function AdminDashboard() {
  ...
  const sidebarItems = [
    { id: "parishes", label: "Gerenciar Paróquias", icon: <Users className="h-4 w-4" /> },
    { id: "requests", label: "Solicitações Pendentes", icon: <FileText className="h-4 w-4" /> },
  ];
          ...
          {activeView === "parishes" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Visualize e gerencie todas as paróquias cadastradas</CardDescription>
              </CardHeader>
              <CardContent>
